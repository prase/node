 ...
 */
export declare function generateSharedDepsMergeStrategy(minEntrypoints: number): BundleStrategy;
/**
 * A bundle strategy function which merges all shared dependencies into a
 * bundle for an application shell.
 */
export declare function generateShellMergeStrategy(shell: UrlString, minEntrypoints: number): BundleStrategy;
/**
